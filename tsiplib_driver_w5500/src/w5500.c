...
int w5500_write_mult(int address, unsigned char bsb, unsigned char* data, uint16_t size);
int w5500_read_mult(int address, unsigned char bsb, unsigned char* data, uint16_t size);
...
int w5500_socket_write_data(unsigned char socketNumber, unsigned char *buf, uint16_t size) {
...
int w5500_socket_read_data(unsigned char socketNumber, unsigned char *buf, uint16_t size) {
        CHECK_SOCKET_NUMBER(socketNumber);
        uint16_t index = 0;
...
int w5500_read_byte(int address, unsigned char bsb, unsigned char *data) {
        return w5500_read_mult(address, bsb, data, (uint16_t) 1);
}
